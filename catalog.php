...
if ($total_items > 0) {
  ...
  if ($current_page < 1) {
    header("location:catalog.php?" . $limit_results . "ph=1");
  }
  //deterime the offset (number of items to skip) for the current page
...
<div class="section catalog page">
    ...
    <div class="wrapper">
        ...
        if ($total_items < 1) {
          ...
          echo "<p>Search again or <a href=\"catalog.php\">Browse Full Catalog</a></p>";
        } else {
          echo $pagination; ?>
        <ul class="items">
            <?php
